...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        supplyChain.contract.events.Packed((err, res) => {
            eventEmitted = true
        })
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferOne[4], originFarmName, 'Error: Invalid item productPrice')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        await supplyChain.buyItem(upc, {from: distributorID, value: web3.utils.toWei("1")})
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], 5, 'Error: Invalid item State, Not Received')
        assert.equal(eventEmitted, true, 'Invalid event emitted')       
    })    
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        // Mark an item as Received by calling function recievedItem()
    ...
    it("Testing smart contract function fetchItemBufferOne() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        var bufferOne = await supplyChain.fetchItemBufferOne.call(upc)
       
        // Verify the result set:
        assert.equal(bufferOne[0], sku, 'Error: Invalid item SKU')
        assert.equal(bufferOne[1], upc, 'Error: Invalid item UPC')
        assert.equal(bufferOne[2], consumerID, 'Error: Missing or Invalid ownerID')
    ...
    it("Testing smart contract function fetchItemBufferTwo() that allows anyone to fetch item details from blockchain", async() => {
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        var bufferTwo = await supplyChain.fetchItemBufferTwo.call(upc)
       
        // Verify the result set:
        assert.equal(bufferTwo[0], sku, 'Error: Invalid item SKU')
        assert.equal(bufferTwo[1], upc, 'Error: Invalid item UPC')
        assert.equal(bufferTwo[2], productID, 'Error: Missing or Invalid productID')
        assert.equal(bufferTwo[3], productNotes, 'Error: Missing or Invalid productNotes')
        assert.equal(bufferTwo[4], productPrice, 'Error: Missing or Invalid productPrice') 
        assert.equal(bufferTwo[5], 7, 'Error: Missing or Invalid itemState')
        assert.equal(bufferTwo[6], distributorID, 'Error: Missing or Invalid distributorID')
        assert.equal(bufferTwo[7], retailerID, 'Error: Missing or Invalid retailerID')
        assert.equal(bufferTwo[8], consumerID, 'Error: Missing or Invalid consumerID')
    })
