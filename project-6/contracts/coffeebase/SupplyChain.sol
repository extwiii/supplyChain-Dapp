...
contract SupplyChain is Ownable, ConsumerRole, DistributorRole, FarmerRole, RetailerRole{
  ...
  modifier paidEnough(uint _price) {
    require(msg.value >= _price, "Amount sent is not enough to buy.");
    _;
  }
  ...
  modifier harvested(uint _upc) {
    require(items[_upc].itemState == State.Harvested, "Item has not been harvested.");
    _;
  }

  // Define a modifier that checks if an item.state of a upc is Processed
  modifier processed(uint _upc) {
    require(items[_upc].itemState == State.Processed, "Item has not been proccessed.");
    _;
  }
  ...
  // if the buyer has paid enough, and any excess ether sent is refunded back to the buyer
